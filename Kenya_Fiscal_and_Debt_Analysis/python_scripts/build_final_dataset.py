...
fiscal_ratios = pd.DataFrame({
    "Year": [2021, 2022, 2023, 2024, 2025],
    "Revenue_GDP": [16.14, 17.48, 16.25, 20.03, 20.03],
    "Expenditure_GDP": [24.02, 23.43, 22.01, 26.36, 26.36],
    "Deficit_GDP": [-7.89, -5.95, -5.76, -6.34, -6.34]
})
...
print(final_df)
final_df.to_csv(
    r"C:\Users\ADMIN\Desktop\Kenya_Fiscal_and_Debt_Analysis\output\final_dataset.csv",
    index=False
)
